const Easing = require('snakesilk-engine/engine/Easing');
const SyncPromise = require('snakesilk-engine/engine/SyncPromise');
const Tween = require('snakesilk-engine/engine/Tween');
